...
<section class="login d-flex align-items-center justify-content-center" style="min-height: 80vh; padding: 40px 20px;">
    <div class="w-100" style="max-width: 460px;">
        <form action="javascript:void(0)" class="w-100 shadow-lg" style="background: var(--bg-card); border: 1px solid var(--border-color); padding: 45px 35px; border-radius: 20px;">
            ...
            <div class="mb-3">
                <input type="text" placeholder="Họ và tên" required class="form-control w-100" style="padding: 12px 18px; font-size: 13px;">
            </div>

            <div class="mb-3">
                <input type="text" placeholder="Tên đăng nhập" required class="form-control w-100" style="padding: 12px 18px; font-size: 13px;">
            </div>

            <div class="mb-3">
                <input type="email" placeholder="Địa chỉ Email" required class="form-control w-100" style="padding: 12px 18px; font-size: 13px;">
            </div>
            ...
            <div class="mb-4">
                <input type="password" placeholder="Nhập lại mật khẩu" required class="form-control w-100" style="padding: 12px 18px; font-size: 13px;">
            </div>
